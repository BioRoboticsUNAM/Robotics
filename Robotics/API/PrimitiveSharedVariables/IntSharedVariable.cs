...
namespace Robotics.API.PrimitiveSharedVariables
{
	...
	public class IntSharedVariable : SharedVariable<int>
	{
		...
		public IntSharedVariable(CommandManager commandManager, string variableName, bool initialize)
		...
		/// <param name="initialize">Indicates if the shared variable will be automatically initialized if the commandManager is different from null</param>
		/// <remarks>If there is no variable with the provided name in the blackboard, a new variable with the asociated name is created</remarks>
		public IntSharedVariable(CommandManager commandManager, string variableName, int value, bool initialize)
		...
		/// <param name="variableName">The name of the variable in the Blackboard</param>
		/// <remarks>If there is no variable with the provided name in the blackboard, a new variable with the asociated name is created</remarks>
		public IntSharedVariable(string variableName)
		...
		/// <param name="value">The value to store in the shared variable if it does not exist</param>
		/// <remarks>If there is no variable with the provided name in the blackboard, a new variable with the asociated name is created</remarks>
		public IntSharedVariable(string variableName, int value)
		...
		protected override bool Deserialize(string serializedData, out int value)
		{
		...
		protected override bool Serialize(int value, out string serializedData)
		{
