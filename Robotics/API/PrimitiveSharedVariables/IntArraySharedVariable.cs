...
namespace Robotics.API.PrimitiveSharedVariables
{
	...
	/// </summary>
	public class IntArraySharedVariable : SharedVariable<int[]>
	{
		#region Variables
		...
		public IntArraySharedVariable(CommandManager commandManager, string variableName, bool initialize)
		...
		/// <param name="initialize">Indicates if the shared variable will be automatically initialized if the commandManager is different from null</param>
		/// <remarks>If there is no variable with the provided name in the blackboard, a new variable with the asociated name is created</remarks>
		public IntArraySharedVariable(CommandManager commandManager, string variableName, int[] value, bool initialize)
		...
		/// <param name="variableName">The name of the variable in the Blackboard</param>
		/// <remarks>If there is no variable with the provided name in the blackboard, a new variable with the asociated name is created</remarks>
		public IntArraySharedVariable(string variableName)
		...
		/// <param name="value">The value to store in the shared variable if it does not exist</param>
		/// <remarks>If there is no variable with the provided name in the blackboard, a new variable with the asociated name is created</remarks>
		public IntArraySharedVariable(string variableName, int[] value)
		...
		protected override bool Deserialize(string serializedData, out int[] values)
		{
			string[] parts;
			int data;
		...
		protected override bool Serialize(int[] values, out string serializedData)
		{
