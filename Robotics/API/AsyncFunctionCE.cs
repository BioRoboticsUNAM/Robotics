...
namespace Robotics.API
{
	...
	/// </summary>
	public class AsyncFunctionCE : AsyncCommandExecuter
	{
		#region Variables
		...
		public AsyncFunctionCE(string commandName, CommandExecuterMethod executerMethod, bool parametersRequired)
			: base(commandName)
		{
